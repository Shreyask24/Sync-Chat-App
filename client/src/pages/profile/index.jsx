...
const Profile = () => {
    ...
    const handleNavigate = () => {
        if (userInfo.profileSetup) {
            ...
            toast.error("Please setup profle.")
        }
    }
            ...
            <div className="flex flex-col gap-10 w-[80vw] md:w-max">
                ...
                <div className='grid grid-cols-2'>
                    ...
                    >
                        ...
                        {hovered && <div className='absolute inset-0 flex justify-center items-center bg-black/50 rounded-full cursor-pointer' onClick={image ? handleDeleteImage : handleFileInputClick}> {image ? <FaTrash className='text-white text-3xl cursor-pointer' /> : <FaPlus className='text-white text-3xl cursor-pointer' />}</div>}
